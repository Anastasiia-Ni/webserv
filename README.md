...
<img src="https://github.com/Anastasiia-Ni/webserv/blob/main/for_RM/HTTP_protocol.jpg" width=70% height=70%>

## About the project: 

This project was completed as part of a 42 core curriculum and it was done with [Kaydooo](https://github.com/Kaydooo) & [AhmadMHammoudeh](https://github.com/AhmadMHammoudeh)
...
- can serve static files from a specified root directory or dynamic content using CGI;
- support GET, HEAD, POST, PUT and DELETE methods;
...
- handle CGI (extensions *.py and *.sh);
...
A basic HTTP web server consists of several components that work together to receive and process HTTP requests from clients and send back responses. 
...
[Here](https://github.com/Anastasiia-Ni/.../format_config_file.conf) is an example fie that shows config file format and supported directives.
...
- [Creating a file upload page](https://www.youtube.com/watch?v=_j5spdsJdV8&t=562s)
- [HTTP cookies](https://www.valentinog.com/blog/cookies/#what-are-cookies-in-web-development)
